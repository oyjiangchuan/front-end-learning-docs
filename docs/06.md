...
```html
@media (min-width: 769px) { .bg { background-image: url(bg1080.jpg); } } @media (max-width: 768px) { .bg {
...
- [Babel 7.1 介绍 transform-runtime polyfill env](https://www.jianshu.com/p/d078b5f3036a)
